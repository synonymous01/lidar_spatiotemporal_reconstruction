...
int main()
{
 ...
 if
(pcl::io::loadPCDFile<pcl::PointXYZRGB>("/home/ibrahim/reconstruction_work/1-2-2023-combined.pcd",
*cloud_rgb) == -1)
 {
 // If failed to load as RGB, try loading as XYZ
 if
(pcl::io::loadPCDFile<pcl::PointXYZ>("/home/ibrahim/reconstruction_work/9-2-2023_combinedf1.pcd",
*cloud_xyz) == -1)
 {
